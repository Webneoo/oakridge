...
<section class="page-header page-header-xs dark">
				<div class="container">
					...
					<h1>FAQRA-KFARDEBIANE MOUNTAINS</h1>

					<!-- breadcrumbs -->
					<ol class="breadcrumb">
						<li><a href="/">Home</a></li>
						<li class="active">The mountains</li>
					</ol><!-- /breadcrumbs -->
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-md-push-6">
							<header class="margin-bottom-60">
								<h2 class="nomargin">Historical Significance</h2>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<header class="margin-bottom-60">
								<h2 class="nomargin">Natural Attraction</h2>
								<p class="font-lato size-20 nomargin">We truly care about our customers</p>
							</header>
			...
			<section>
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-md-push-6">
							<header class="margin-bottom-60">
								<h2 class="nomargin">Dazzling Views</h2>
								<p class="font-lato size-20 nomargin">We truly care about our customers</p>
							</header>
			...
			<section>
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<header class="margin-bottom-60">
								<h2 class="nomargin">Location</h2>
								<p class="font-lato size-20 nomargin">The peak of luxury</p>
							</header>
...
Oakridge is splendid all year round. In summer or in winter, the professional management services ensure each little aspect is operating perfectly and all is safe and secure. Oakridge is quality living’s address.</p>
						...
						<div class="col-md-6 col-sm-6">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3307.9719080037617!2d35.80678357893717!3d33.993255316067945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f4eb0ec9d7ecb%3A0xef5910b29c4379bf!2sOakridge+Mountain+Resort!5e0!3m2!1sen!2slb!4v1468306162112" width="547" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
