		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-md-push-6">
				<header class="margin-bottom-60">
					<h2 class="nomargin">BLOCK G</h2>
					<p class="font-lato size-20 nomargin">Tranquil town appeal</p>
				</header>

				<p>Spacious attached villas embody a pleasant neighbourly feel heightened by the select comfort of space. Privacy blends with proximity to typify tranquil moments.<br><br>
					Private gardens, private terraces, private parking spaces. <br>
				Composed of 3 floors and 1 basement:<br>
				<b>Ground floor:</b> garden and patio - open reception area and study<br>
			...
			<div class="col-md-6 col-sm-6 col-md-pull-6">
				<img class="img-responsive" src="/assets/images/blockg.jpg"  width="547"  alt="service" />
			</div>
						...
						<figure>
							<span class="item-hover">
								...
								<span class="inner">
									...
									<!-- lightbox -->
									<a class="ico-rounded lightbox" href="/assets/images/blockg/blockg9.jpg" data-plugin-options='{"type":"image"}'>
										<span class="fa fa-plus size-20"></span>
									</a>

								</span>
							</span>
							<img class="img-responsive" src="/assets/images/blockg/blockg9.jpg" width="600" height="399" alt="">
						</figure>
					</div>
